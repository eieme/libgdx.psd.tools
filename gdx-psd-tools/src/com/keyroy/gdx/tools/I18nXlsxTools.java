...
public class I18nXlsxTools{
	  public static String importFolder = "excel/i18n";

	  public static String jsonFolder = "json/i18n";

	  public static String jsonZipFolder = "json zip/i18n";
	  ...
	  public static final void execute()
	  {
	    ...
	    if (folder.exists()) {
	      ...
	      if (files != null){
		        for (File file : files){
		        	  try {
		  	            List<JsonPack> arrays = I18nXlsxParser.parser(file);
